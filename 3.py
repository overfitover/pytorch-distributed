...
print("1")
dist.init_process_group(init_method='file:///home/yxk/new_project/c_study/share', backend="gloo", world_size=4, group_name="pytorch_test")
...
for epoch in range(1, args.epochs + 1):
    ...
    print("Epoch {} of {} took {:.3f}s".format(epoch, args.epochs, end_cpu_secs - start_cpu_secs))
